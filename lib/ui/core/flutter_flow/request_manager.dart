...
/// MVVM-friendly aliases for request managers.
typedef AppFutureRequestManager<T> = FutureRequestManager<T>;
typedef AppStreamRequestManager<T> = StreamRequestManager<T>;
