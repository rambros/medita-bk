...
/// MVVM-friendly aliases for form controllers.
typedef AppFormFieldController<T> = FormFieldController<T>;
typedef AppFormListFieldController<T> = FormListFieldController<T>;
