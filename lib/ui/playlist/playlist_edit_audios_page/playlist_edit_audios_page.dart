...
import 'package:medita_bk/ui/playlist/select_audio_dialog/select_audio_dialog.dart';
import 'package:medita_bk/core/utils/media/audio_utils.dart';
import 'package:medita_bk/ui/core/utils/ui_utils.dart';
...
class PlaylistEditAudiosPage extends StatefulWidget {
  ...
  static String routeName = 'playlistEditAudiosPage';
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.updatePlaylistStruct(
        (e) => e..audios = _model.editListAudios!.toList(),
      );
    });
