...
import 'package:medita_b_k/data/models/firebase/music_model.dart';
import 'package:medita_b_k/data/repositories/music_repository.dart';
...
class _SelectMusicPageState extends State<SelectMusicPage> {
  ...
  void initState() {
    super.initState();
    _model = SelectMusicPageViewModel()..init(context);
