...
class AgendaHomePage extends StatefulWidget {
  ...
  static String routeName = 'agendaHomePage';
  static String routePath = 'agendaHomePage';

  @override
  State<AgendaHomePage> createState() => _AgendaHomePageState();
}

class _AgendaHomePageState extends State<AgendaHomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'agendaHomePage'});
    // On page load action.
  ...
  Widget build(BuildContext context) {
    ...
    // In a real app, this would be provided at a higher level or via a wrapper
    // For now, we assume it's provided in main.dart or we can wrap it here if needed,
    // but the plan says main.dart.
