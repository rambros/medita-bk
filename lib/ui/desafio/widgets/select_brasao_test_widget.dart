...
class SelectBrasaoTestWidget extends StatefulWidget {
  const SelectBrasaoTestWidget({super.key});

  @override
  State<SelectBrasaoTestWidget> createState() => _SelectBrasaoTestWidgetState();
}

class _SelectBrasaoTestWidgetState extends State<SelectBrasaoTestWidget> {
  late SelectBrasaoTestModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectBrasaoTestModel());
