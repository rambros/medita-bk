              ...
              child: CarouselSlider.builder(
                ...
                itemBuilder: (context, index, _) {
                  ...
                  return ClipRRect(
                    borderRadius: BorderRadius.circular(8.0),
                    child: () {
                      final parsedUrl = Uri.tryParse(urlMandalasItem);
                        ...
                        return Image.network(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            return Container(
                              ...
                              child: Icon(Icons.filter_vintage, color: Colors.grey[600], size: 100),
                            );
                          },
                        );
                      } else {
            ...
            child: Image.network(
              ...
              errorBuilder: (context, error, stackTrace) {
                return Container(
                  ...
                  height: 270.0,
                  color: Colors.grey[300],
                  child: Icon(Icons.filter_vintage, color: Colors.grey[600], size: 108),
                );
              },
            ),
          ),
