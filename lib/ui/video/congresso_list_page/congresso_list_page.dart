...
import 'view_model/congresso_list_view_model.dart';
...
class _CongressoListPageState extends State<CongressoListPage> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'congressoListPage'});
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {}));
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<CongressoListViewModel>(
