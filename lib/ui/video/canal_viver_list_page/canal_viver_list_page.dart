...
import 'view_model/canal_viver_list_view_model.dart';
...
class _CanalViverListPageWidgetState extends State<CanalViverListPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'canalViverListPage'});
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {}));
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<CanalViverListViewModel>(
