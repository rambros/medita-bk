...
class PlaylistModelStruct extends FFFirebaseStruct {
  ...
  static PlaylistModelStruct? maybeFromMap(dynamic data) =>
      data is Map ? PlaylistModelStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static PlaylistModelStruct fromSerializableMap(Map<String, dynamic> data) => PlaylistModelStruct(
        id: deserializeParam(
          data['id'],
          ParamType.String,
          false,
  ...
  static PlaylistModelStruct fromAlgoliaData(Map<String, dynamic> data) => PlaylistModelStruct(
  ...
  @override
  int get hashCode => const ListEquality().hash([id, title, description, imageUrl, duration, audios]);
}
...
void addPlaylistModelStructData(
  ...
  final clearFields = !forFieldValue && playlistModel.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final playlistModelData = getPlaylistModelFirestoreData(playlistModel, forFieldValue);
  final nestedData = playlistModelData.map((k, v) => MapEntry('$fieldName.$k', v));
...
Map<String, dynamic> getPlaylistModelFirestoreData(
  ...
  playlistModel.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);
...
List<Map<String, dynamic>> getPlaylistModelListFirestoreData(
  List<PlaylistModelStruct>? playlistModels,
    ...
    playlistModels?.map((e) => getPlaylistModelFirestoreData(e, true)).toList() ?? [];
