...
class MensagemStruct extends FFFirebaseStruct {
  ...
  static MensagemStruct fromSerializableMap(Map<String, dynamic> data) => MensagemStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
          false,
  ...
  static MensagemStruct fromAlgoliaData(Map<String, dynamic> data) => MensagemStruct(
  ...
  bool operator ==(Object other) {
    return other is MensagemStruct && id == other.id && title == other.title && mensagem == other.mensagem;
  }
...
void addMensagemStructData(
  ...
  final clearFields = !forFieldValue && mensagemStruct.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final mensagemStructData = getMensagemFirestoreData(mensagemStruct, forFieldValue);
  final nestedData = mensagemStructData.map((k, v) => MapEntry('$fieldName.$k', v));
...
Map<String, dynamic> getMensagemFirestoreData(
  ...
  mensagemStruct.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);
