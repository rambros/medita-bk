...
class VenueStruct extends FFFirebaseStruct {
  ...
  static VenueStruct fromSerializableMap(Map<String, dynamic> data) => VenueStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
          false,
  ...
  @override
  int get hashCode => const ListEquality().hash([id, name, address, postalCode, locality, country, email, phone]);
}
...
void addVenueStructData(
  ...
  final clearFields = !forFieldValue && venue.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
