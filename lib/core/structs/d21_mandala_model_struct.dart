...
class D21MandalaModelStruct extends FFFirebaseStruct {
  ...
  void incrementDiaCompletado(int amount) => diaCompletado = diaCompletado + amount;
  ...
  static D21MandalaModelStruct fromMap(Map<String, dynamic> data) => D21MandalaModelStruct(
        diaCompletado: castToType<int>(data['diaCompletado']),
        mandalaUrl: data['mandala_url'] as String?,
      );

  static D21MandalaModelStruct? maybeFromMap(dynamic data) =>
      data is Map ? D21MandalaModelStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static D21MandalaModelStruct fromSerializableMap(Map<String, dynamic> data) => D21MandalaModelStruct(
  ...
  static D21MandalaModelStruct fromAlgoliaData(Map<String, dynamic> data) => D21MandalaModelStruct(
  ...
  bool operator ==(Object other) {
    return other is D21MandalaModelStruct && diaCompletado == other.diaCompletado && mandalaUrl == other.mandalaUrl;
  }
...
void addD21MandalaModelStructData(
  ...
  final clearFields = !forFieldValue && d21MandalaModel.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final d21MandalaModelData = getD21MandalaModelFirestoreData(d21MandalaModel, forFieldValue);
  final nestedData = d21MandalaModelData.map((k, v) => MapEntry('$fieldName.$k', v));
...
Map<String, dynamic> getD21MandalaModelFirestoreData(
  ...
  d21MandalaModel.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);
...
List<Map<String, dynamic>> getD21MandalaModelListFirestoreData(
  List<D21MandalaModelStruct>? d21MandalaModels,
    ...
    d21MandalaModels?.map((e) => getD21MandalaModelFirestoreData(e, true)).toList() ?? [];
