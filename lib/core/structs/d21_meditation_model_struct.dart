...
class D21MeditationModelStruct extends FFFirebaseStruct {
  ...
  void incrementAudioDuration(int amount) => audioDuration = audioDuration + amount;
  ...
  static D21MeditationModelStruct fromMap(Map<String, dynamic> data) => D21MeditationModelStruct(
  ...
  static D21MeditationModelStruct? maybeFromMap(dynamic data) =>
      data is Map ? D21MeditationModelStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static D21MeditationModelStruct fromSerializableMap(Map<String, dynamic> data) => D21MeditationModelStruct(
  ...
  static D21MeditationModelStruct fromAlgoliaData(Map<String, dynamic> data) => D21MeditationModelStruct(
...
void addD21MeditationModelStructData(
  ...
  final clearFields = !forFieldValue && d21MeditationModel.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final d21MeditationModelData = getD21MeditationModelFirestoreData(d21MeditationModel, forFieldValue);
  final nestedData = d21MeditationModelData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = d21MeditationModel.firestoreUtilData.create || clearFields;
...
Map<String, dynamic> getD21MeditationModelFirestoreData(
  ...
  d21MeditationModel.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);
...
List<Map<String, dynamic>> getD21MeditationModelListFirestoreData(
  List<D21MeditationModelStruct>? d21MeditationModels,
    ...
    d21MeditationModels?.map((e) => getD21MeditationModelFirestoreData(e, true)).toList() ?? [];
