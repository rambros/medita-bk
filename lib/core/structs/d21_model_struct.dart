...
class D21ModelStruct extends FFFirebaseStruct {
  ...
  List<D21MeditationModelStruct> get d21Meditations => _d21Meditations ?? const [];
  set d21Meditations(List<D21MeditationModelStruct>? val) => _d21Meditations = val;
  ...
  void incrementEtapasCompletadas(int amount) => etapasCompletadas = etapasCompletadas + amount;
  ...
  void incrementDiasCompletados(int amount) => diasCompletados = diasCompletados + amount;
  ...
  static D21ModelStruct fromMap(Map<String, dynamic> data) => D21ModelStruct(
        ...
        d21Status: data['d21Status'] is D21Status ? data['d21Status'] : deserializeEnum<D21Status>(data['d21Status']),
  ...
  static D21ModelStruct fromSerializableMap(Map<String, dynamic> data) => D21ModelStruct(
  ...
  static D21ModelStruct fromAlgoliaData(Map<String, dynamic> data) => D21ModelStruct(
...
void addD21ModelStructData(
  ...
  final clearFields = !forFieldValue && d21Model.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
...
Map<String, dynamic> getD21ModelFirestoreData(
  ...
  d21Model.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);
