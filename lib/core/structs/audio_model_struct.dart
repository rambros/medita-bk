...
class AudioModelStruct extends FFFirebaseStruct {
  ...
  static AudioModelStruct? maybeFromMap(dynamic data) =>
      data is Map ? AudioModelStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static AudioModelStruct fromSerializableMap(Map<String, dynamic> data) => AudioModelStruct(
        id: deserializeParam(
          data['id'],
          ParamType.String,
          false,
  ...
  static AudioModelStruct fromAlgoliaData(Map<String, dynamic> data) => AudioModelStruct(
  ...
  @override
  int get hashCode => const ListEquality().hash([id, title, author, fileLocation, fileType, duration, audioType]);
}
...
void addAudioModelStructData(
  ...
  final clearFields = !forFieldValue && audioModel.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
...
Map<String, dynamic> getAudioModelFirestoreData(
  ...
  audioModel.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);
