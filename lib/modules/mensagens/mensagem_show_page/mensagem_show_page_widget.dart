...
import 'mensagem_show_page_model.dart';
export 'mensagem_show_page_model.dart';

class MensagemShowPageWidget extends StatefulWidget {
  const MensagemShowPageWidget({
    super.key,
    required this.tema,
  ...
  @override
  State<MensagemShowPageWidget> createState() => _MensagemShowPageWidgetState();
}

class _MensagemShowPageWidgetState extends State<MensagemShowPageWidget>
    with TickerProviderStateMixin {
  late MensagemShowPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MensagemShowPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'mensagemShowPage'});
    // On page load action.
