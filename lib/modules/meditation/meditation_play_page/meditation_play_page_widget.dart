...
import 'meditation_play_page_model.dart';
export 'meditation_play_page_model.dart';
...
class MeditationPlayPageWidget extends StatefulWidget {
  ...
  @override
  State<MeditationPlayPageWidget> createState() =>
      _MeditationPlayPageWidgetState();
}

class _MeditationPlayPageWidgetState extends State<MeditationPlayPageWidget>
    with TickerProviderStateMixin {
  late MeditationPlayPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditationPlayPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'meditationPlayPage'});
