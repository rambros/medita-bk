...
import 'confirma_reset_desafio_model.dart';
export 'confirma_reset_desafio_model.dart';

class ConfirmaResetDesafioWidget extends StatefulWidget {
...
class _ConfirmaResetDesafioWidgetState extends State<ConfirmaResetDesafioWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmaResetDesafioModel());
