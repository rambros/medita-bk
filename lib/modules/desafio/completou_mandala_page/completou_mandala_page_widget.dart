...
class CompletouMandalaPageWidget extends StatefulWidget {
  ...
  @override
  State<CompletouMandalaPageWidget> createState() =>
      _CompletouMandalaPageWidgetState();
}

class _CompletouMandalaPageWidgetState
    extends State<CompletouMandalaPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'completouMandalaPage'});
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              await actions.shareImageAndText(
