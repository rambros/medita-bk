...
import 'home_desafio_page_model.dart';
export 'home_desafio_page_model.dart';

class HomeDesafioPageWidget extends StatefulWidget {
  const HomeDesafioPageWidget({super.key});

  static String routeName = 'homeDesafioPage';
  static String routePath = 'homeDesafioPage';

  @override
  State<HomeDesafioPageWidget> createState() => _HomeDesafioPageWidgetState();
}

class _HomeDesafioPageWidgetState extends State<HomeDesafioPageWidget> {
  late HomeDesafioPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeDesafioPageModel());
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Builder(
                                  builder: (context) {
                                    if (FFAppState().desafio21.isD21Completed) {
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        'Etapa ${valueOrDefault<String>(
                                                          FFAppState().desafio21.etapaAtual.toString(),
                                                          '1',
                                                        )}',
                                                        style: FlutterFlowTheme.of(context).labelLarge.override(
                                                    ...
                                                    Builder(
                                                      builder: (context) {
                                                        if (valueOrDefault<bool>(
                                                                currentUserDocument?.desafio21Started, false) ==
                                                            false) {
                                                          return Column(
                                                            mainAxisSize: MainAxisSize.max,
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                              ...
                                                              FFButtonWidget(
                                                                onPressed: () async {
                                                                  await currentUserReference!
                                                                    ...
                                                                    desafio21: createD21ModelStruct(
                                                                      title: FFAppState().desafio21.title,
                                                                      description: FFAppState().desafio21.description,
                                                                      etapasCompletadas: 0,
                                                                      etapaAtual: 1,
                                                                      diasCompletados: 0,
                                                                      diaAtual: 1,
                                                                      ...
                                                                      fieldValues: {
                                                                        'd21_meditations':
                                                                            getD21MeditationModelListFirestoreData(
                                                                          FFAppState().desafio21.d21Meditations,
                                                                        ),
                                                                      },
                                                                  ...
                                                                  context.pushNamed(
                                                                    DesafioOnboardingPageWidget.routeName,
                                                                    extra: <String, dynamic>{
                                                                      kTransitionInfoKey: const TransitionInfo(
                                                                        hasTransition: true,
                                                                        transitionType: PageTransitionType.fade,
                                      ...
                                      Flexible(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              context.pushNamed(
                                                ConquistasPageWidget.routeName,
                                                extra: <String, dynamic>{
                                                  kTransitionInfoKey: const TransitionInfo(
                                                    hasTransition: true,
                                                    transitionType: PageTransitionType.fade,
                                      ...
                                      Flexible(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              context.pushNamed(
                                                DiarioMeditacaoPageWidget.routeName,
                                                extra: <String, dynamic>{
                                                  kTransitionInfoKey: const TransitionInfo(
                                                    hasTransition: true,
                                                    transitionType: PageTransitionType.fade,
