...
import 'diario_meditacao_page_model.dart';
export 'diario_meditacao_page_model.dart';

class DiarioMeditacaoPageWidget extends StatefulWidget {
  const DiarioMeditacaoPageWidget({super.key});
...
class _DiarioMeditacaoPageWidgetState extends State<DiarioMeditacaoPageWidget> {
  late DiarioMeditacaoPageModel _model;
