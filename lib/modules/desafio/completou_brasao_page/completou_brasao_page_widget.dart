...
import 'completou_brasao_page_model.dart';
export 'completou_brasao_page_model.dart';

class CompletouBrasaoPageWidget extends StatefulWidget {
  const CompletouBrasaoPageWidget({
    super.key,
...
class _CompletouBrasaoPageWidgetState extends State<CompletouBrasaoPageWidget> {
  late CompletouBrasaoPageModel _model;
