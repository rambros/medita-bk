...
import 'app_review_page_model.dart';
export 'app_review_page_model.dart';
...
class _AppReviewPageWidgetState extends State<AppReviewPageWidget> {
  late AppReviewPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppReviewPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'appReviewPage'});
