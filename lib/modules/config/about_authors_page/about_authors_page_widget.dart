...
import 'about_authors_page_model.dart';
export 'about_authors_page_model.dart';
...
class _AboutAuthorsPageWidgetState extends State<AboutAuthorsPageWidget> {
  late AboutAuthorsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AboutAuthorsPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'aboutAuthorsPage'});
