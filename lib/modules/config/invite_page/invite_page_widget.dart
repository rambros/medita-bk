...
class _InvitePageWidgetState extends State<InvitePageWidget> {
  ...
  void initState() {
    ...
    _model.inviteTextTextController ??= TextEditingController();
    _model.inviteTextFocusNode ??= FocusNode();

    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.inviteTextTextController?.text =
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              4.0, 24.0, 4.0, 24.0),
                          child: TextFormField(
                            controller: _model.inviteTextTextController,
                            focusNode: _model.inviteTextFocusNode,
                            autofocus: false,
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.inviteTextTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                              if (!isAndroid && !isiOS)
