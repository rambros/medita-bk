...
import 'playlist_save_page_model.dart';
export 'playlist_save_page_model.dart';
...
class _PlaylistSavePageWidgetState extends State<PlaylistSavePageWidget> {
  late PlaylistSavePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlaylistSavePageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'playlistSavePage'});
                                        ...
                                        return WebViewAware(
                                          child: Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: const SelectImagesPlaylistWidget(),
                                          ),
                                        );
                                      },
