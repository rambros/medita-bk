...
import 'playlist_list_page_model.dart';
export 'playlist_list_page_model.dart';
...
class _PlaylistListPageWidgetState extends State<PlaylistListPageWidget> {
  late PlaylistListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlaylistListPageModel());
                        ...
                        Container(
                          ...
                          child: AuthUserStreamWidget(
                            builder: (context) => Builder(
                              builder: (context) {
                                final playlists =
                                    (currentUserDocument?.playlists.toList() ??
                                            [])
                                        .toList();
