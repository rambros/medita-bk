...
import 'entrevistas_list_page_model.dart';
export 'entrevistas_list_page_model.dart';
...
class EntrevistasListPageWidget extends StatefulWidget {
  ...
  @override
  State<EntrevistasListPageWidget> createState() =>
      _EntrevistasListPageWidgetState();
}

class _EntrevistasListPageWidgetState extends State<EntrevistasListPageWidget> {
  late EntrevistasListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EntrevistasListPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'entrevistasListPage'});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final entrevistasListPageCanalBrahmaKumarisResponse = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: FutureBuilder<ApiCallResponse>(
                future: YouTubeGroup.videosEntrevistasCall.call(),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  if (!snapshot.hasData) {
                    return Center(
                  ...
                  final containerVideosEntrevistasResponse = snapshot.data!;
                          ...
                          children: [
                                          ...
                                          child: Image.network(
                                            valueOrDefault<String>(
                                              YouTubeGroup
                                                  ...
                                                  .profilePicture(
                                                entrevistasListPageCanalBrahmaKumarisResponse
                                                    .jsonBody,
                                              ),
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  '${YouTubeGroup.videosEntrevistasCall.totalVideosPlaylist(
                                                        containerVideosEntrevistasResponse
                                                            .jsonBody,
                                                      ).toString()} vídeos',
                                                  style:
                                                      FlutterFlowTheme.of(
                            ...
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final videoList =
                                      YouTubeGroup.videosEntrevistasCall
                                              .items(
                                                containerVideosEntrevistasResponse
                                                    .jsonBody,
                                              )
