...
import 'congresso_list_page_model.dart';
export 'congresso_list_page_model.dart';
...
class CongressoListPageWidget extends StatefulWidget {
  ...
  @override
  State<CongressoListPageWidget> createState() =>
      _CongressoListPageWidgetState();
}

class _CongressoListPageWidgetState extends State<CongressoListPageWidget> {
  late CongressoListPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CongressoListPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'congressoListPage'});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final congressoListPageCanalBrahmaKumarisResponse = snapshot.data!;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: FutureBuilder<ApiCallResponse>(
                future: YouTubeGroup.videosCongressoCall.call(
                  maxResults: '45',
                  pageToken: '',
                ),
                builder: (context, snapshot) {
                  ...
                  final containerVideosCongressoResponse = snapshot.data!;
                          ...
                          children: [
                                          ...
                                          child: Image.network(
                                            valueOrDefault<String>(
                                              YouTubeGroup
                                                  ...
                                                  .profilePicture(
                                                congressoListPageCanalBrahmaKumarisResponse
                                                    .jsonBody,
                                              ),
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  '${YouTubeGroup.videosCongressoCall.totalVideosPlaylist(
                                                        containerVideosCongressoResponse
                                                            .jsonBody,
                                                      ).toString()} vídeos',
                                                  style:
                                                      FlutterFlowTheme.of(
                            ...
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final videoList =
                                      YouTubeGroup.videosCongressoCall
                                              .items(
                                                containerVideosCongressoResponse
                                                    .jsonBody,
                                              )
