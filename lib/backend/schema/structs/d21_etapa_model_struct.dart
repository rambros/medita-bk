...
class D21EtapaModelStruct extends FFFirebaseStruct {
  ...
  void incrementDiaiInicioEtapa(int amount) =>
      diaiInicioEtapa = diaiInicioEtapa + amount;
  ...
  static D21EtapaModelStruct fromMap(Map<String, dynamic> data) =>
      D21EtapaModelStruct(
  ...
  static D21EtapaModelStruct? maybeFromMap(dynamic data) => data is Map
      ? D21EtapaModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static D21EtapaModelStruct fromSerializableMap(Map<String, dynamic> data) =>
      D21EtapaModelStruct(
  ...
  static D21EtapaModelStruct fromAlgoliaData(Map<String, dynamic> data) =>
      D21EtapaModelStruct(
...
void addD21EtapaModelStructData(
  ...
  final clearFields =
      !forFieldValue && d21EtapaModel.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final d21EtapaModelData =
      getD21EtapaModelFirestoreData(d21EtapaModel, forFieldValue);
  final nestedData =
      d21EtapaModelData.map((k, v) => MapEntry('$fieldName.$k', v));
...
Map<String, dynamic> getD21EtapaModelFirestoreData(
  ...
  d21EtapaModel.firestoreUtilData.fieldValues
...
List<Map<String, dynamic>> getD21EtapaModelListFirestoreData(
  List<D21EtapaModelStruct>? d21EtapaModels,
    ...
    d21EtapaModels
        ?.map((e) => getD21EtapaModelFirestoreData(e, true))
        .toList() ??
    [];
