...
class SearchedMessagesStruct extends FFFirebaseStruct {
  ...
  static SearchedMessagesStruct fromMap(Map<String, dynamic> data) =>
      SearchedMessagesStruct(
  ...
  static SearchedMessagesStruct? maybeFromMap(dynamic data) => data is Map
      ? SearchedMessagesStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static SearchedMessagesStruct fromSerializableMap(
  ...
  static SearchedMessagesStruct fromAlgoliaData(Map<String, dynamic> data) =>
      SearchedMessagesStruct(
  ...
  bool operator ==(Object other) {
    ...
    return other is SearchedMessagesStruct &&
        search == other.search &&
...
void addSearchedMessagesStructData(
  ...
  final clearFields =
      !forFieldValue && searchedMessages.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final searchedMessagesData =
      getSearchedMessagesFirestoreData(searchedMessages, forFieldValue);
  final nestedData =
      searchedMessagesData.map((k, v) => MapEntry('$fieldName.$k', v));
...
Map<String, dynamic> getSearchedMessagesFirestoreData(
  ...
  searchedMessages.firestoreUtilData.fieldValues
...
List<Map<String, dynamic>> getSearchedMessagesListFirestoreData(
  List<SearchedMessagesStruct>? searchedMessagess,
    ...
    searchedMessagess
        ?.map((e) => getSearchedMessagesFirestoreData(e, true))
        .toList() ??
    [];
