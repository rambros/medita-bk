...
class MeditationLogStruct extends FFFirebaseStruct {
  ...
  static MeditationLogStruct fromMap(Map<String, dynamic> data) =>
      MeditationLogStruct(
  ...
  static MeditationLogStruct? maybeFromMap(dynamic data) => data is Map
      ? MeditationLogStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static MeditationLogStruct fromSerializableMap(Map<String, dynamic> data) =>
      MeditationLogStruct(
  ...
  static MeditationLogStruct fromAlgoliaData(Map<String, dynamic> data) =>
      MeditationLogStruct(
  ...
  bool operator ==(Object other) {
    return other is MeditationLogStruct &&
...
void addMeditationLogStructData(
  ...
  final clearFields =
      !forFieldValue && meditationLog.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final meditationLogData =
      getMeditationLogFirestoreData(meditationLog, forFieldValue);
  final nestedData =
      meditationLogData.map((k, v) => MapEntry('$fieldName.$k', v));
...
Map<String, dynamic> getMeditationLogFirestoreData(
  ...
  meditationLog.firestoreUtilData.fieldValues
...
List<Map<String, dynamic>> getMeditationLogListFirestoreData(
  List<MeditationLogStruct>? meditationLogs,
    ...
    meditationLogs
        ?.map((e) => getMeditationLogFirestoreData(e, true))
        .toList() ??
    [];
