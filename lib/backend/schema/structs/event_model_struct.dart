...
class EventModelStruct extends FFFirebaseStruct {
  ...
  void incrementRegistrationCount(int amount) =>
      registrationCount = registrationCount + amount;
  ...
  static EventModelStruct fromMap(Map<String, dynamic> data) =>
      EventModelStruct(
        ...
        venue: data['venue'] is VenueStruct
            ? data['venue']
            : VenueStruct.maybeFromMap(data['venue']),
      );

  static EventModelStruct? maybeFromMap(dynamic data) => data is Map
      ? EventModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static EventModelStruct fromSerializableMap(Map<String, dynamic> data) =>
      EventModelStruct(
        id: deserializeParam(
          data['id'],
          ParamType.int,
  ...
  static EventModelStruct fromAlgoliaData(Map<String, dynamic> data) =>
      EventModelStruct(
...
void addEventModelStructData(
  ...
  final clearFields =
      !forFieldValue && eventModel.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
...
Map<String, dynamic> getEventModelFirestoreData(
  ...
  eventModel.firestoreUtilData.fieldValues
