...
class D21BrasaoModelStruct extends FFFirebaseStruct {
  ...
  static D21BrasaoModelStruct fromMap(Map<String, dynamic> data) =>
      D21BrasaoModelStruct(
  ...
  static D21BrasaoModelStruct? maybeFromMap(dynamic data) => data is Map
      ? D21BrasaoModelStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static D21BrasaoModelStruct fromSerializableMap(Map<String, dynamic> data) =>
      D21BrasaoModelStruct(
  ...
  static D21BrasaoModelStruct fromAlgoliaData(Map<String, dynamic> data) =>
      D21BrasaoModelStruct(
...
void addD21BrasaoModelStructData(
  ...
  final clearFields =
      !forFieldValue && d21BrasaoModel.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final d21BrasaoModelData =
      getD21BrasaoModelFirestoreData(d21BrasaoModel, forFieldValue);
  final nestedData =
      d21BrasaoModelData.map((k, v) => MapEntry('$fieldName.$k', v));
...
Map<String, dynamic> getD21BrasaoModelFirestoreData(
  ...
  d21BrasaoModel.firestoreUtilData.fieldValues
...
List<Map<String, dynamic>> getD21BrasaoModelListFirestoreData(
  List<D21BrasaoModelStruct>? d21BrasaoModels,
    ...
    d21BrasaoModels
        ?.map((e) => getD21BrasaoModelFirestoreData(e, true))
        .toList() ??
    [];
