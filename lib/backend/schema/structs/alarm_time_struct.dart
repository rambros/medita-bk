...
class AlarmTimeStruct extends FFFirebaseStruct {
  ...
  static AlarmTimeStruct? maybeFromMap(dynamic data) => data is Map
      ? AlarmTimeStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static AlarmTimeStruct fromSerializableMap(Map<String, dynamic> data) =>
      AlarmTimeStruct(
  ...
  static AlarmTimeStruct fromAlgoliaData(Map<String, dynamic> data) =>
      AlarmTimeStruct(
  ...
  bool operator ==(Object other) {
    return other is AlarmTimeStruct &&
        key == other.key &&
...
void addAlarmTimeStructData(
  ...
  final clearFields =
      !forFieldValue && alarmTime.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
...
Map<String, dynamic> getAlarmTimeFirestoreData(
  ...
  alarmTime.firestoreUtilData.fieldValues
