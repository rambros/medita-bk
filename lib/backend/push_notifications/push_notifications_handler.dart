...
final parametersBuilderMap =
  ...
  'meditationDetailsPage': (data) async => ParameterData(
        allParams: {
          'meditationDocRef':
              getParameter<DocumentReference>(data, 'meditationDocRef'),
        },
      ),
  'meditationPlayPage': (data) async => ParameterData(
        allParams: {
          'meditationDoc': await getDocumentParameter<MeditationsRecord>(
              data, 'meditationDoc', MeditationsRecord.fromSnapshot),
        },
      ),
  ...
  'desafioPlayPage': (data) async => ParameterData(
        allParams: {
          'indiceListaMeditacao':
              getParameter<int>(data, 'indiceListaMeditacao'),
        },
      ),
