...
import '../../services/auth/firebase_auth/auth_util.dart';
...
void logFirebaseEvent(String eventName, {Map<String?, dynamic>? parameters}) {
  ...
  parameters ??= {};
  parameters.putIfAbsent('user', () => currentUserUid.isEmpty ? 'unset' : currentUserUid);
  ...
  FirebaseAnalytics.instance.logEvent(name: eventName, parameters: params.cast<String, Object>());
}
