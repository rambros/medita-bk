import '/componentes/select_brasao_test/select_brasao_test_widget.dart';
import '/componentes/select_mandala_test/select_mandala_test_widget.dart';
...
class SelectBrasaoOrMandalaTestWidget extends StatefulWidget {
...
class _SelectBrasaoOrMandalaTestWidgetState extends State<SelectBrasaoOrMandalaTestWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectBrasaoOrMandalaTestModel());
